...
export const StockChart = ({ chartData, symbol }) => {
    ...
    //datamizin icindeki son aray sayis - ilk array sayisinda buyukse >0 yesil
    //degilse kirmizi yani < 0 ise 
    ...
    //butona tikladigimida secilen butonun digerlerine gore daha visible olamsini saglar 
    ...
    return (
        <div className="mt-5 p-4 shadow-sm bg-white">
            ...
            <div>
                <button class={renderButtonSelect("24")} onClick={() => setDateFormat("24h")}>24h</button>
            ...
            {/* //buton degistikce setDateFormat da degisir */}
