...
export const StockList = () => {
  ...
  return (
    <div
     ...
     bg-black h-full 
     ">
      <table className="border-3 border-white-100 w-full h-full text-white" >
        <thead >
          <tr>
            <th>Name</th>
            <th>Last</th>
            ...
            return (
              ...
              >
                ...
                <td className={`text-${changeColor(stockData.data.d)} arrow`}>
                  <p className="flex flex-row text-center justify-center items-center">{stockData.data.d} {renderIcon(stockData.data.d)}</p>
                </td>
                <td className={`text-${changeColor(stockData.data.d)} arrow`}>
                <p className="flex flex-row text-center justify-center items-center">{stockData.data.dp} {renderIcon(stockData.data.dp)}</p>
                </td>
