...
export const AutoComplete = () => {
  ...
  return <div className=" mx-auto flex justify-center text-center items-center">
    <div className="form-floating dropdown w-full text-center items-center justify-center">
      <input  id="search" type="text"
       className="text-white bg-black  w-1/2 form-control " placeholder="Search" autoComplete="off"
