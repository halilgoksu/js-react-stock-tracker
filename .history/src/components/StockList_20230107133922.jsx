  ...
  return (
    <div className="bg-black sm:text-sm" >
      <table striped bordered hover variant="dark"
       className="flex-col p-0 m-0 sm:text-sm md:text-sm ">
        <thead className="text-sm text-red-900">
          <tr className="">
        ...
        <tbody className="flex-col text-sm text-blue-800">
          {stock.map((stockData) => {
            return (
              ...
              >
                <th className="text-sm">{stockData.symbol}</th>
                {/* //Marka ismi  */}

                <td className="flex border-2 text-xsm">{stockData.data.c}</td>
