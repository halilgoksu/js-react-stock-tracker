...
export const StockList = () => {
  ...
  const handleStockSelect = (handleStockData) => {
    if(handleStockData.data.c>0){
      console.log(handleStockData.data.c)
      navigate(`detail/${handleStockData.symbol}`);

    }else{
      return{
          <Route path="/nodata" component={NoDataApi} />
        }
    }
  };
