            ...
            return (
              ...
              >
                ...
                <td className={`text-${changeColor(stockData.data.d)} arrow`}>
                  <p className="bg-red-100 flex flex-row">{stockData.data.d} {renderIcon(stockData.data.d)}</p>
                </td>
                <td className={`text-${changeColor(stockData.data.d)} arrow`}>
                 <p className="bg-red-100 flex flex-row">{stockData.data.dp} {renderIcon(stockData.data.dp)}</p>
                </td>
