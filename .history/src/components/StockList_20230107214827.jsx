...
export const StockList = () => {
  ...
  return (
    <div
     className="table hover  flex-col justify-center items-center text-center border-2 border-red-900">
      <table className="bg-black border-3 border-white-100  text-white table-auto w-full"  >
        <thead >
