...
export const StockList = () => {
  ...
  return (
    <div
     ...
     text-white bg-black">
      <Table
       className=" border-3 border-white  table-auto w-full shadow-lg"  >
        ...
        <Tbody>
          ...
          {stock.map((stockData) => {
            return (
              ...
              >
                <Td className="border-2 border-wh">{stockData.symbol}</Td>
                ...
                <Td>
                  ...
                  <Button variant="outline-danger" className="d-inline-block "
                    onClick={(e) => {
                      e.stopPropagation();
