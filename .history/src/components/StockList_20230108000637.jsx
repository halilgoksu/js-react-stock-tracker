          ...
          {stock.map((stockData) => {
            return (
              ...
              >
                ...
                <Td>
                <button
                    className="d-inline-block delete-button 
                    bg-red-500 hover:bg-blue-400 text-white font-bold py-2 px-4 border-b-4 border-blue-700 hover:border-blue-500 rounded"
                    onClick={(e) => {
                      e.stopPropagation();
