...
const StockList = () => {
  ...
  const { watchList,delet } = useContext(WatchListContext);
      ...
      <table className="table hover mt-5 ">
        <thead style={{ color: "rgb(79,89,102)" }}>
          <tr>
            ...
            <th scope="col">PcClose
            <button className="btn btn-danger btn-sm ml-3 d-inline-block  delete-button">Remove</button></th>
          </tr>
        </thead>
