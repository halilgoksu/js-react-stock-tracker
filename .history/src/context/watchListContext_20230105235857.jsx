...
export const WatchListContextProvider=(props)=>{
    const [watchList, setWatchList] = useState(
        ...
        //watchlistte ilk olarak gidip local storage render etmeye calisir
        //eger varsa orda bir sey , string olan seyi parcalar ve render eder
        //eger localstorage bos ise || ["GGOLE"] flan filan render et 
        //? eger watchlist bos ise eror almamizi engller , kod calismaya devam eder
    ...
    useEffect(()=>{localStorage.setItem("watchlist",watchList)},[watchList])
     ...
     //temel amac kulanic f5 yaptiginda , listye koydugun elemani tekrar hatirlamak 
