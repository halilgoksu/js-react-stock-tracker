...
export const NoDataApi = () => {
 const  navigate=useNavigate();
  ...
  return (
    <div className="flex w-full h-full item-center justify-center text-center p-4 text-gray-400 ">
      ...
      <h6 className="fixed font-mono z-1 6 text-xs text-white ">@Goksu</h6>
