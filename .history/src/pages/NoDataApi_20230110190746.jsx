...
export  const NoDataApi = () => {
  return (
    <div className='flex w-full h-full item-center justify-center text-center p-4 bg-white boder-4 border-red-200'>

    <div className='flex-col justify-center  items-center text-center p-4 mt-9 w-2/3  '>
